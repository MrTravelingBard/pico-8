	...
	if battle.state==battle_state.player_turn then
		...
		if btnp(4) and battle.anim_timer<=0 then
			if battle.battle_select == 1 then
				...
				draw_battle_animation(228,3,1)
				if battle_anim==false then
...
function draw_battle()
	...
	if battle.state==battle_state.win or battle.state==battle_state.lose then
		...
		print(battle.message,44,50,col)
	end
end
...
function draw_bar(x,y,val,maxval,col)
	local w=40
	rect(x,y,x+w,y+4,7)
	local fill=flr((val/maxval)*w)-1
	rectfill(x+1,y+1,x+fill,y+3,col)
	print(val.."/"..maxval,x+w+2,y,7)
end

function draw_battle_animation(starting_spr,frames,target)
	battle_anim=true
	local spr1=starting_spr
	local spr2=starting_spr+1
	local spr3=starting_spr+16
	local spr4=starting_spr+17	
	if battle.anim_timer<=0 then
		if battle.frames<frames then
			battle.frames+=1
			spr1+=battle.frames
			spr2+=battle.frames
			spr3+=battle.frames
...

__label__
